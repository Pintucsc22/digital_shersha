...
//           addMessage(
//             `Great! Let's begin your ${formattedRole} registration. Please write your full name`,
//             "bot"
//           );
//           setStep(1);
//         } else {
...
//         {/* Header */}
//         <div className="bg-gradient-to-r from-indigo-900 via-purple-700 to-pink-600 text-white p-4 flex justify-between items-center rounded-t-2xl shadow-md">
//           <span className="font-bold text-lg animate-pulse">Chat Registration</span>
//           <button
//             onClick={onClose}
...
// export default RegisterChatBox;
